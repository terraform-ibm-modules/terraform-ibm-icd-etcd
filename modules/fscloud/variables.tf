...
variable "access_tags" {
  type        = list(string)
  description = "A list of access tags to apply to the etcd_db instance created by the module, see https://cloud.ibm.com/docs/account?topic=account-access-tags-tutorial for more details"
  default     = []
}
